...
// Diamond variables
const diamondSound = new Audio("../assets/sounds/coin.wav");
const diamondImage = new Image(60, 60);
diamondImage.src = "../assets/images/green lucky.png";
const diamondHitboxRadius = 30;
let diamondXSpeed = -10;
const diamondSpawnInterval = 10;
...
// Speed variables
const speedSound = new Audio("../assets/sounds/coin.wav");
const speedImage = new Image(60, 60);
speedImage.src = "../assets/images/fjer.jpg";
const speedHitboxRadius = 30;
const speedXSpeed = -10;
const speedSpawnInterval = 10;
let speedTimeSinceLastSpawn = speedSpawnInterval
let speedXPosition = canvas.width
let speedYPosition = randomBetween(0,canvas.height) 
let speeds = [];
